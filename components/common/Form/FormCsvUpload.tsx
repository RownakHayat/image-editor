...
const FormCsvUpload = (props: Props) => {
  const {
    register,
    setValue,
    getValues,
  ...
  const onChangeFileUpload = async (e: any) => {
    ...
    if (!file || file.type !== 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
      ToastError("Please upload only .xlsx files.");
      return;
    }
    ...
    try {
      ...
      ToastError("Failed to upload the file. Please try again.");
    }
  };
            ...
            >
              <div className="w-full flex justify-center flex-col items-center space-y-1">
                ...
                <p className="text-sm text-center">
                  ...
                  &nbsp;  or drag and drop  <br /> File Extension must be (.xlsx)
                </p>
              </div>
              <input
                type="file"
