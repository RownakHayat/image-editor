...
const FormUserImageUpload = (props: Props) => {
  const {
    register,
    setValue,
    getValues,
      ...
      <div className="my-3">
        ...
        >
          {imageLayout ? (
            <label
              htmlFor={props.name}
              className="py-10 transition-all bg-gray-50 sm:w-[100%] md:w-[90%] lg:w-[72%] xl:w-[100%] border border-[#9EAFFE] block border-dashed text-black p-4 rounded-lg cursor-pointer"
              onDrop={onDrop}
            ...
            <div className="bg-gray-50 w-[62%] border transition-all border-[#9EAFFE] block border-dashed text-black overflow-hidden rounded-lg cursor-pointer">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="absolute top-1 right-[5.5rem] bg-white p-1 rounded-lg">
                  <Icons.delete
                    onClick={() => {
                      setValue(props.name, "");
                      setImageDetails("");
...
export default FormUserImageUpload;
